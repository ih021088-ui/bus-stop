...
> 사당역9번출구앞은 서울시 정류장이라 경기도 GBIS API 대신 서울특별시 버스도착정보조회 API(ARS: 20253)로 조회. 도착 시간은 제공되나 잔여석 정보는 서울 버스 API 특성상 미제공.
...
3. **사당역 잔여석 정보 없음** — 서울 버스 API로 도착 시간은 연동 완료, 잔여석은 미제공
